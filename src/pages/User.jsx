...
import {FaUserFriends, FaUsers, FaStore, FaCodepen} from "react-icons/fa"
    ...
    return (
        <>
            <div className="w-full mx-auto lg:w10/12">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-col-2 mb-8 md:gap-8">
